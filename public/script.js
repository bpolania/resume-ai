class ResumeChat {
    ...
    updateSocialLinks() {
        ...
        if (!socialLinksContainer || !this.resumeData.personalInfo) return;
        ...
        if (personalInfo.twitter) {
            const twitterUrl = personalInfo.twitter.startsWith('http') ? 
                personalInfo.twitter : 
                `https://twitter.com/${personalInfo.twitter.replace('@', '')}`;
    ...
    async loadResumeData() {
        ...
        // Update social links after resume data is loaded
